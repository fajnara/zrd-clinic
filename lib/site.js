...
export const site = {
  ...
  team: [
    {
      name: "dr. Sari Wulandari", // ⚠️ DUMMY — ganti nama dokter asli
      role: "Dokter Penanggung Jawab",
      cred: "Tenaga medis berlisensi · STR aktif", // ⚠️ isi No. STR asli kalau ada
      photo: "/dr-amalia.webp", // ⚠️ foto stok — ganti foto asli
    },
    {
      name: "Rina Maharani", // ⚠️ DUMMY — ganti nama terapis asli
      role: "Terapis Estetika",
      cred: "Bersertifikat",
      photo: "/rina.webp", // ⚠️ foto stok — ganti foto asli
    },
  ],
  legal: {
    note: "ZRD Clinic mengantongi izin resmi dan mematuhi standar layanan klinik estetika demi jaminan keamanan setiap pasien.",
  },
};
